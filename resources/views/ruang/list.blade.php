...
<div class="row">
    <form action="" method="get" class="col-md-8 row">
        <div class="col-md-5 px-0">
            <div class="form-group">
                <input type="text"
                class="form-control" name="searchbox" placeholder="masukan nama ruang ...">
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="col-md-4 text-right px-0">
        <a href="{{URL::to('/master/ruang/tambah')}}">
                ...
                <td width="10%">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{URL::to('/master/ruang/ubah/'.$item['id'])}}">
                                <span>
...
<script>
    function deleteModal(id) {
        let selected_element = ruang.data.find(function (data) {
            return data.id==id
         });
        let textString = "Apakah anda ingin menghapus Ruang "+selected_element.nama_ruang+" ?";
        $("#modelId .modal-body").text(textString);
        let url = "{{URL::to('/master/ruang/hapus/')}}"+"/"+selected_element.id;
        console.log(url);
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda ingin menghapus ruang
            </div>
