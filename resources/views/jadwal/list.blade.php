...
<div class="row">
    ...
    <div class="col-md-4 text-right px-0">
        <a href="{{URL::to('/penjadwalan/jadwal/tambah')}}">
                ...
                <td width="10%">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{URL::to('/penjadwalan/jadwal/detail/'.$item->id)}}">
                                <span>
                                    <i class="fas fa-info"></i>
                                    Detail
                                </span>
                            </a>
                            <a class="dropdown-item" href="{{URL::to('/penjadwalan/jadwal/export/'.$item->id)}}">
                                <span>
